...
//////////////////////////////////////////////////////////////////////////
// AProjectilePredictionCharacter

AProjectilePredictionCharacter::AProjectilePredictionCharacter()
{
...
void AProjectilePredictionCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent))
	{
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AProjectilePredictionCharacter::Move);
...
void AProjectilePredictionCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AProjectilePredictionCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
...
bool AProjectilePredictionCharacter::GetHasRifle()
{
	return bHasRifle;
}